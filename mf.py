...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 10, 501, 31))
        self.verticalLayoutWidget.setObjectName("verticalLayoutWidget")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.label = QtWidgets.QLabel(self.verticalLayoutWidget)
        self.label.setMinimumSize(QtCore.QSize(493, 0))
        self.label.setObjectName("label")
        self.verticalLayout.addWidget(self.label, 0, QtCore.Qt.AlignLeft)
        self.verticalLayoutWidget_2 = QtWidgets.QWidget(Form)
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(10, 50, 501, 26))
        ...
        self.find_string = QtWidgets.QLineEdit(self.verticalLayoutWidget_2)
        self.find_string.setObjectName("find_string")
        self.horizontalLayout.addWidget(self.find_string)
        self.verticalLayout_2.addLayout(self.horizontalLayout)
        self.horizontalLayoutWidget_3 = QtWidgets.QWidget(Form)
        self.horizontalLayoutWidget_3.setGeometry(QtCore.QRect(10, 83, 501, 24))
        ...
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(10, 116, 501, 31))
        ...
        self.verticalLayoutWidget_4.setGeometry(QtCore.QRect(10, 160, 501, 381))
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Парсер информации с сайта zakupki.gov.ru по выбраному ключевому слову за указанный период"))
        self.label_2.setText(_translate("Form", "Ключевоес слово для поиска:"))
        self.label_3.setText(_translate("Form", "Дата начала тендеров:"))
